...
- **Customizable Favorites Grid**: Choose between 1, 2, or 3 columns (limit 4, 8, or 12 apps).
- **Niagara-style Index Bar**: Dynamic "Wave" effect with intense pop-out and large bold fonts.
...
- **Interactive UI**: Buttons with visual feedback for mode switching.
